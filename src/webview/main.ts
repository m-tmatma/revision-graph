...
import type { GraphCommit, GraphNode, HostToWebviewMessage, LaidOutGraph, WebviewToHostMessage } from '../shared/types';
...
if (!rootEl || !statusEl) {
  throw new Error('Git Revision Graph: webview markup is missing #graph-root/#graph-status');
}
